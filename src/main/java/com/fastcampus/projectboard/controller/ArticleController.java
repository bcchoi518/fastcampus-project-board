...
public class ArticleController {
    ...
    public String updateArticleForm(@PathVariable Long articldId, ModelMap map) {
        ArticleResponse article = ArticleResponse.from(articleService.getArticle(articldId));
